...
- (void)initializeMovieWithOutputSettings:(NSDictionary *)outputSettings;
{
    ...
    // use default filter settings if none specified
    ...
    // custom filter settings specified
    else
    {
    ...
    */
    ...
    // You need to use BGRA for the video in order to get realtime encoding. I use a color-swizzling shader to line up glReadPixels' normal RGBA filter with the movie input's BGRA.
