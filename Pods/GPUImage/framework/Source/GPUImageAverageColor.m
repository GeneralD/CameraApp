...
- (void)extractAverageColorAtFrameTime:(CMTime)frameTime;
{
    ...
    NSAssert(self.outputTextureOptions.internalFormat == GL_RGBA, @"The filter texture internal format for this filter must be GL_RGBA.");
    NSAssert(self.outputTextureOptions.type == GL_UNSIGNED_BYTE, @"The type of the filter texture of this filter must be GL_UNSIGNED_BYTE.");
