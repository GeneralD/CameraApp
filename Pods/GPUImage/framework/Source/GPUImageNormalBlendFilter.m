...
//     outputColor.a = c1.a + c2.a * (1.0 - c1.a);
     ...
     lowp float alphaDivisor = a + step(a, 0.0); // Protect against a divide-by-zero blacking out things in the filter
...
(
 ...
 void main()
 {
     ...
     float alphaDivisor = a + step(a, 0.0); // Protect against a divide-by-zero blacking out things in the filter
